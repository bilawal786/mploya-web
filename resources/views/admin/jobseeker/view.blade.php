                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.all.jobseeker')}}">Job Seekers</a>
                                </li>
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        ...
                                        @else
                                        <img class="profile-user-img img-fluid img-circle"
                                            src="{{asset($jobseeker->image)}}" alt="User profile picture">
                                        @endif
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted"><b>Certification Name:</b>
                                        ...
                                        <span
                                            class="tag tag-danger">{{$jobseeker->certification_description[$key]}},</span>
                                        @endforeach
                                        @endif
                                    </p>
                                    <hr>
                                ...
                                <div class="card-header p-2">
                                    <ul class="nav nav-pills">
                                        <li class="nav-item"><a class="nav-link active" href="#jobs"
                                                data-toggle="tab">Applied Jobs</a></li>
