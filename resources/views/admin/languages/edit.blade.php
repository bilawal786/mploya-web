                            ...
                            <form method="POST" action="{{route('admin.language.update', ['id' => $lan->id])}}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l190" class="form-control" value="{{$lan->l190}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l191" class="form-control" value="{{$lan->l191}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l192" class="form-control" value="{{$lan->l192}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l193" class="form-control" value="{{$lan->l193}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l194" class="form-control" value="{{$lan->l194}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l195" class="form-control" value="{{$lan->l195}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l196" class="form-control" value="{{$lan->l196}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l197" class="form-control" value="{{$lan->l197}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l198" class="form-control" value="{{$lan->l198}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l199" class="form-control" value="{{$lan->l199}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l200" class="form-control" value="{{$lan->l200}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l201" class="form-control" value="{{$lan->l201}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l202" class="form-control" value="{{$lan->l202}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l203" class="form-control" value="{{$lan->l203}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l204" class="form-control" value="{{$lan->l204}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l205" class="form-control" value="{{$lan->l205}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l206" class="form-control" value="{{$lan->l206}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l207" class="form-control" value="{{$lan->l207}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l208" class="form-control" value="{{$lan->l208}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l209" class="form-control" value="{{$lan->l209}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l210" class="form-control" value="{{$lan->l210}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l211" class="form-control" value="{{$lan->l211}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l212" class="form-control" value="{{$lan->l212}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l213" class="form-control" value="{{$lan->l213}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l214" class="form-control" value="{{$lan->l214}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l215" class="form-control" value="{{$lan->l215}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l216" class="form-control" value="{{$lan->l216}}" required>
                                            </div>
                                        </div>
                                         {{-- new --}}
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l217" class="form-control" value="{{$lan->l217}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l218" class="form-control" value="{{$lan->l218}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l219" class="form-control" value="{{$lan->l219}}" required>
                                            </div>
                                        </div><div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l220" class="form-control" value="{{$lan->l220}}" required>
                                            </div>
                                        </div><div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l221" class="form-control" value="{{$lan->l221}}" required>
                                            </div>
                                        </div><div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l222" class="form-control" value="{{$lan->l222}}" required>
                                            </div>
                                        </div>
                                         <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l223" class="form-control" value="{{$lan->l223}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l224" class="form-control" value="{{$lan->l224}}" required>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l225" class="form-control" value="{{$lan->l225}}" required>
                                            </div>
                                        </div><div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l226" class="form-control" value="{{$lan->l226}}" required>
                                            </div>
                                        </div><div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l227" class="form-control" value="{{$lan->l227}}" required>
                                            </div>
                                        </div><div class="col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="l228" class="form-control" value="{{$lan->l228}}" required>
                                            </div>
                                        </div>
                                         </div><div class="col-sm-12">
                                            <div class="form-group">
