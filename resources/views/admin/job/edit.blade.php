               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{route('admin.all.jobs')}}"
                                class="nav-link {{ $link == route('admin.all.jobs') ? 'active':'' }}">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
              ...
              ?>
                                ...
                                <form id="jobform">
                                    @csrf
                                    <input type="hidden" name="status" value="{{$job->status}}" class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" min="1" name="vacancies" class="form-control"
                                        ...
                                        <div class="row">
                                               <div class="col-sm-12">
                                                    ...
                                                    <textarea id="summernotetwo" class="form-control" name="requirements" rows="7"
                                                        cols="30">{{$job->requirements}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-bordered table-striped" id="user_table_a"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><button type="button" name="remove" id=""
                                                            class="btn btn-success" onclick="addmore()"><i
                                                                class="fa fa-plus"></button></th>
                                                </tr>
                                            </thead>

                                            <tbody>
                                                @foreach($job->skills as $key => $data1)
                                                <tr>
                                                    <td><input type="text" value="{{$job->skills[$key]}}"
                                                            name="skills[]" class="form-control" />
                                                    </td>
                                                    <td><button type="button" name="remove" id=""
                                                            class="btn btn-danger removetest"><i
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" id="sunmit" class="btn btn-primary">Update</button>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card -->
    ...
    <script>
        function addmore() {
            ...
            function dynamic_field(number) {
                html = '<tr>';
                html += '<td><input type="text" name="skills[]" class="form-control"  placeholder="Required"/></td>';
                if (number > 0) {
                    html +=
                        '<td><button type="button" name="remove" id="" class="btn btn-danger removetest"><i class="fa fa-trash"></button></td></tr>';
                    $('#jobform tbody').append(html);
                } else {
                    html +=
                        '<td><button type="button" name="add" id="addtest" class="btn btn-success"><i class="fa fa-plus"></i></button></button></td></tr>';
                    $('#jobform tbody').html(html);
                }
            }
