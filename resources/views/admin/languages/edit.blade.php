                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    {{-- // --}}
                                     <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text" name="l309" class="form-control" value="{{$lan->l309}}"
                                                required>
                                        </div>
                                    </div>
                                     <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text" name="l310" class="form-control" value="{{$lan->l310}}"
                                                required>
                                        </div>
                                    </div>
                                     <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text" name="l311" class="form-control" value="{{$lan->l311}}"
                                                required>
                                        </div>
                                    </div>
                                      {{-- // --}}
                                     <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text" name="l312" class="form-control" value="{{$lan->l312}}"
                                                required>
                                        </div>
                                    </div>
                                     <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text" name="l313" class="form-control" value="{{$lan->l313}}"
                                                required>
                                        </div>
                                    </div>
                                     <div class="col-sm-12">
                                        <div class="form-group">
                                            <input type="text" name="l314" class="form-control" value="{{$lan->l314}}"
                                                required>
                                        </div>
                                    </div>
                                </div>
